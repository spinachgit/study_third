...
public class PushExample {
	static Logger logger = LoggerFactory.getLogger(PushExample.class);
	private static String ALERT = "AAAA";
	private static String TITLE = "TITLE11";
	private static String MSG_CONTENT = "msg_content";
	
	
    public static void main(String[] args) {

        JPushClient jpushClient = new JPushClient(Constants.masterSecret, Constants.appKey, 3);
