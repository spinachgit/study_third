...
public class JPushUtil {
     ...
     * @return Notification
     */
    private static Message newMessage(Map<String, String> extras) {
    ...
    public static void main(String[] args) {
        ...
        Audience audience = Audience.all();
        //Message message
        Message message = newMessage(extras);
        message.content("fdsafdsa");
        PushResult result = null;
		try {
			result = JPushUtil.push(platform, audience, null, message);
		} catch (Exception e) {
